...
class CollaborativeFilterModel(object):
    ...
    def __init__(self):
        ...
        movies_with_ratings = self.movies.join(
            self.ratings.set_index('movieId'), on='movieId')
...
if __name__ == '__main__':
    dump_model('models/collaborative_filter.pickle')
    print(load_model('models/collaborative_filter.pickle').get_recommends(2, [1, 2, 3, 4, 8, 22, 65]))
